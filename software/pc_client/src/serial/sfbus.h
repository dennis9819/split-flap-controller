...
#define SFBUS_RETRY_COUNT 3
#define SFBUS_MAX_BUFFER_SIZE 128

#ifndef SFBUS_H
#define SFBUS_H
typedef struct SEMVER
{
    u_int8_t maj;   // SemVer Major Version number
    u_int8_t min;   // SemVer Minor Version number
    u_int8_t patch; // SemVer Patch Version number
} SEMVER;
#endif
